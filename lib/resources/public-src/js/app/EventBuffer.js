...
export const binaryInsert = (buffer, data) => {
    ...
    const time = data.payload.eventPayload.event.timeStamp;
    ...
    while (left <= right) {
        ...
        const check = buffer[index].payload.eventPayload.event.timeStamp;
...
export class EventBuffer {
     ...
     */
    add(data) {
        const eventPayload = data.payload.eventPayload;
        const time = eventPayload.event.timeStamp;
