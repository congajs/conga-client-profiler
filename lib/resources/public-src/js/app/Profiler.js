...
export class Profiler {
    ...
    constructor(options = {}) {
        ...
        this.eventHandler({
            ...
            data: {
                ...
                timing: this.performance.timing.toJSON()
            }
        });
    }
     ...
     */
    get performance() {
        return window.performance || window.webkitPerformance || window.mozPerformance
    ...
    eventHandler(payload) {
        ...
        const performance = window.performance || window.webkitPerformance || window.mozPerformance
                                || window.msPerformance;
